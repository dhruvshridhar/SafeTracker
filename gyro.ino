...
String sample=" Latitude: 28.005811,Longitude: 73.337783";
TinyGPSPlus ss;

void setup() {
  Serial.println(F("Running GPS Module"));
  Serial.println(F("A simple script of TinyGPS++ with an attached GPS module"));
  Serial.print(F("Getting GPS Location>>>>>"));
  Serial.println(F("by Safe Trackers"));
  Serial.println();
...
//////////////////////////////////////Gyro read/////////////////////////////////////
    ...
    * If you multiply degrees/seconds by seconds you obtain degrees */
    ...
    Serial.print(Gyr_rawY);Serial.println(sample);
    //Serial.print("   |   ");
